    ...
    <div className='flex justify-center sm:px-4 p-12 '>
      ...
      <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text4-xl font-semibold ml-4 xs:ml-0">
          ...
          <div className='mt-16 '>
            ...
            <div className='mt-4'>
              <div {...getRootProps()} className={fileStyle}>
                ...
                <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-xl">JPEG, PNG, SVG, WEBP. MAX 100mb</p>
                <div className='my-12 w-full flex justify-center'>
                  <Image src={images.upload} width={100} height={100} objectFit='contain' alt='fileupload' className={theme === 'light' && 'filter-invert'}/>
                </div>
          ...
          <Input inputType ='input'
            title='Name' placeholder ='NFT Name' 
          ...
          <Input inputType ='number'
            title='Price' placeholder ='NFT Price' 
